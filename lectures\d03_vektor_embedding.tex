...
\begin{frame}{So'zni qanday qilib raqamga aylantiramiz? Siyrakdan zichgacha}
  \begin{columns}[T]
    ...
    \begin{column}{0.46\textwidth}
      ...
      keladi: \textit{``issiq \underline{\hspace{0.7cm}} ichdim''} $\Rightarrow$ vektorlari
...
\begin{frame}{Sizning vazifangiz: qaysi juft yaqinroq?}
  ...
  \begin{tcolorbox}[okbox,title=Javob]
    ...
    \textit{``yangi \underline{\hspace{0.7cm}} sotib oldim''}, \textit{``\underline{\hspace{0.7cm}} ni haydadi''}.
